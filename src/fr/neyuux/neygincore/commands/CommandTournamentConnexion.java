...
public class CommandTournamentConnexion implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String alias, String[] args) {
		...
		if (!main.getServer().getPluginManager().getPlugin("Tournoi").isEnabled()) {
			...
			Bukkit.broadcastMessage(main.getPrefix() + "§8§l» §eLe plugin §6§lTournoi §evient d'Ãªtre dÃ©marrÃ© pour faire des inscriptions ! Il restera allumÃ© pour 30 secondes.");
			return true;
		}
