...
public enum CurrentGame {
	...
	LG("LG", "§c§lLoups§e§l-§6§lGarous", Material.MONSTER_EGG, "§7Mode de jeu stratégique, obtient ton rôle, joue et gagne avec ton camp. Sauras-tu rentrer dans la t§te de tes amis ?", "Neyuux_", "Philippe des Palli§res et Herv§ Marly", 5, 26, "LG", 130, 16.5, 380),
